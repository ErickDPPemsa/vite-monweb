...
export const SideBar = () => {
    ...
    return (
        <aside id="menu-sidebar" ref={AsideRef} className="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full md:-translate-x-0 bg-slate-50 dark:bg-slate-900 shadow-lg">
